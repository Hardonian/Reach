# Trust Negotiation Specification ## 1. Overview
...
## 2. Handshake Protocol The handshake is extended to include a "Capability Advertisement":
...
## 3. Verification Rules Nodes MUST enforce the following rules before establishing a session:
...
## 4. Determinism Levels - **Level 0 (None)**: No guarantees.
...
## 5. Trust Segregation - **Cross-Org Trust**: Nodes from different OrgIDs require Signed Capability Snapshots and explicit policy negotiation.
