  ...
  return (
    <DocLayout currentPath="/docs/troubleshooting" title="Troubleshooting">
      <p className="text-lg text-slate-600 mb-8">
        Common issues, debug workflows, and how to generate comprehensive bug reports
        for the Reach team.
      </p>
...
./reach report verify demo-report/`}
      />
      <p className="mt-2">
        Creates a shareable artifact with hashes, timeline, and environment snapshot.
...
./reach explain <decision-id> --verbose`}
      ...
      <ol className="list-decimal pl-6 space-y-2">
        ...
        <li>Output of <code>./reach doctor</code></li>
        <li>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>
          ...
          <a href="https://github.com/reach/reach/issues/new?template=bug_report.yml" className="text-blue-600 hover:underline">
            File an issue
          </a>
        </li>
        <li>
          <strong>Feature Requests:</strong>{' '}
          <a href="https://github.com/reach/reach/issues/new?template=feature_request.yml" className="text-blue-600 hover:underline">
            Submit idea
          </a>
        </li>
        <li>
          <strong>Discussions:</strong>{' '}
          <a href="https://github.com/reach/reach/discussions" className="text-blue-600 hover:underline">
            GitHub Discussions
          </a>
        </li>
      </ul>
