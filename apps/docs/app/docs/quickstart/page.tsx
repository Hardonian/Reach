...
pnpm install`}
      ...
      <p className="mt-4">
        The doctor command checks all dependencies, file permissions, and deterministic 
        environment requirements. You should see all checks pass.
      </p>
      ...
      <p>
        Run the same command twice. The transcript hash will be identical—this is Reach's
        core guarantee.
      </p>
      <CodeBlock
        code={`# Run once
...
# Hashes match ✓`}
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>Explore the <a href="/docs/examples" className="text-blue-600 hover:underline">six core examples</a></li>
        <li>Choose a <a href="/docs/presets" className="text-blue-600 hover:underline">preset</a> for your use case</li>
        <li>Build a <a href="/docs/plugins" className="text-blue-600 hover:underline">plugin</a> to extend Reach</li>
      </ul>
    </DocLayout>
  )
}
