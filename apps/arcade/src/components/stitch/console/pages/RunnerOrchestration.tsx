                  ...
                  <tbody className="divide-y divide-[#30363d] text-xs">
                    {[
                      ...
                      <tr key={r.id} className="hover:bg-white/5 transition-colors">
                        ...
                        <td className="px-8 py-6">
                          <span
                            className={`px-2 py-0.5 rounded-full font-black uppercase tracking-widest text-[9px] bg-${r.c}-500/10 text-${r.c}-400 border border-${r.c}-500/20`}
                          >
                            {r.s}
                          </span>
                        </td>
                        <td className="px-8 py-6">
                          <div className="w-48 bg-slate-800 rounded-full h-1 overflow-hidden">
                            <div
                              className={`h-full bg-${r.c}-500 transition-all`}
                              style={{ width: `${r.p}%` }}
                            ></div>
                          </div>
                        </td>
            ...
            <div className="p-10 rounded-3xl border border-dashed border-[#30363d] bg-[#161b22]/30 flex flex-col gap-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    id="runner-alias"
                    className="bg-[#0d1117] border border-[#30363d] rounded-xl px-4 py-3 text-xs text-white outline-none focus:ring-1 focus:ring-[#135bec]"
                    placeholder="Runner Name / Alias"
                  />
                </div>
                <div className="flex flex-col gap-1.5">
                  <label
                  ...
                  <select
                    id="target-pool"
                    className="bg-[#0d1117] border border-[#30363d] rounded-xl px-4 py-3 text-xs text-white outline-none appearance-none"
                  >
              ...
              <button
                type="button"
                className="w-fit px-8 py-3 bg-[#135bec] hover:bg-blue-600 text-white text-[10px] font-black uppercase tracking-widest rounded-xl transition-all shadow-xl shadow-blue-500/20"
              >
                Trigger Execution
              </button>
            </div>
            ...
            <div className="bg-[#161b22] border border-[#30363d] rounded-2xl p-8 flex flex-col gap-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={job.name}
                    className="flex flex-col gap-2 p-4 rounded-xl bg-[#0d1117] border border-[#30363d] hover:border-[#135bec]/30 transition-all"
                  >
                    <div className="flex justify-between items-start">
                      ...
                      <span
                        className={`text-[9px] font-black uppercase tracking-widest ${job.stat === "PAUSED" ? "text-amber-500" : "text-emerald-500"}`}
                      >
                        {job.stat}
                      </span>
                    </div>
