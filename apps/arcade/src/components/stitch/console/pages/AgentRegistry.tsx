...
export function AgentRegistry() {
  const agents: AgentEntry[] = [
    ...
    },
    {
      ...
      repo: "github/cs-bot",
      version: "v1.0.9",
      capabilities: ["Classification", "Jira"],
      health: "Degraded",
      errorRate: "1.45%",
      lastRun: "12s ago",
      lastRunId: "#1f9d3x8",
    ...
    {
      id: "3",
      name: "research-summarizer-beta",
      org: "R&D Lab",
      repo: "github/rd-sum",
      version: "v0.5.0-beta",
      capabilities: ["NLP", "Python"],
      health: "Offline",
      errorRate: "0.00%",
      lastRun: "2d ago",
      lastRunId: "#------",
    ...
    {
      id: "5",
      name: "ecom-rec-engine",
      org: "Sales Org",
      repo: "github/rec-sys",
      version: "v3.0.1",
      capabilities: ["Vector DB", "Search"],
      health: "Healthy",
      errorRate: "0.00%",
      lastRun: "45s ago",
      lastRunId: "#3f8a1c9",
      ...
      <header className="shrink-0 border-b border-slate-800 bg-[#111318]/50 backdrop-blur-md z-10">
        <div className="px-6 py-4 flex flex-col gap-4">
          <div className="flex items-center gap-2 text-sm">
            <a className="text-slate-400 hover:text-slate-200" href="#">
              ReadyLayer
            </a>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-2">
            {[
              ...
              <div
                key={stat.label}
                className="bg-slate-800/50 border border-slate-700/50 rounded-lg p-4 flex flex-col"
              >
      ...
      <div className="flex-1 overflow-auto p-6 pt-2">
          ...
          <div className="flex flex-col lg:flex-row gap-3 items-start lg:items-center justify-between">
            <div className="relative w-full lg:w-96 group">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <span className="material-symbols-outlined text-slate-500 group-focus-within:text-[#135bec] transition-colors">
                  search
                </span>
              </div>
              <input
                className="block w-full pl-10 pr-3 py-2 bg-slate-800 border border-slate-700 rounded-lg text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-[#135bec] focus:border-[#135bec] sm:text-sm"
        ...
        <div className="mt-6 flex items-center justify-between">
          ...
          <nav className="inline-flex rounded-md shadow-sm -space-x-px">
            ...
            <button
              type="button"
              className="px-4 py-2 bg-[#135bec]/20 border border-[#135bec] text-[#135bec] text-sm font-medium"
            >
              1
            </button>
            <button
              type="button"
              className="px-4 py-2 bg-slate-800 border border-slate-700 text-slate-400 hover:bg-slate-700 text-sm font-medium transition-colors"
            >
              2
            </button>
            <button
            ...
            <span className="px-4 py-2 bg-slate-800 border border-slate-700 text-slate-400 text-sm">
              ...
            </span>
            <button
              type="button"
