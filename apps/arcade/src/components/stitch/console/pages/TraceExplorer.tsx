    ...
    <div className="flex-1 flex flex-col h-full overflow-hidden bg-[#0a0c10] font-sans">
      <header className="h-16 border-b border-[#1e232b] bg-[#0d1117]/95 backdrop-blur flex items-center justify-between px-8 shrink-0 z-20">
        <div className="flex items-center gap-2">
          <span className="text-[#9da6b9] text-sm uppercase font-bold tracking-widest">
            Console
          </span>
        ...
        <div className="flex items-center gap-4">
          <div className="relative group">
            <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[#3b82f6] text-[18px]">
              search
            </span>
            <input
              className="bg-[#161b22] border border-[#30363d] rounded-lg pl-10 pr-4 py-2 text-xs text-white w-64 outline-none focus:ring-1 focus:ring-[#3b82f6]"
              placeholder="Trace ID or Agent..."
            />
          </div>
          <button
            type="button"
      ...
      <div className="flex-1 flex overflow-hidden">
              ...
              {[
                {
                  ...
                  status: "SUCCESS",
                  time: "12ms",
                  details: "Routed to Settlement Specialist",
                  icon: "route",
                },
                {
                  id: "step-02",
                  ...
                  status: "SUCCESS",
                  time: "450ms",
                  details: "Parsed invoice metadata from S3",
                  icon: "database",
                },
                {
                  id: "step-03",
                ...
                },
                {
                  id: "step-04",
                  type: "OUTPUT",
                  title: "Payload Finalization",
                  status: "SUCCESS",
                  time: "24ms",
                  details: "JSON signed and dispatched to Zeo",
                  icon: "output",
                },
              ].map((step, i) => (
                <div
                  ...
                  <div className="flex-1 bg-[#161b22] border border-[#30363d] rounded-2xl p-6 transition-all group-hover:border-[#3b82f6]/30">
                    <div className="flex justify-between items-start mb-2">
                      <div className="flex flex-col">
                        <span className="text-[10px] font-black uppercase tracking-widest text-[#3b82f6] mb-1">
                          {step.type}
                        </span>
                      ...
                      <div className="flex flex-col items-end">
                        <span
                          className={`text-[9px] font-black uppercase tracking-widest px-2 py-0.5 rounded border ${step.status === "WARNING" ? "text-amber-400 bg-amber-500/10 border-amber-500/20" : "text-emerald-400 bg-emerald-500/10 border-emerald-500/20"}`}
                        >
                          {step.status}
                        </span>
        ...
        <div className="w-[450px] border-l border-[#1e232b] bg-[#0d1117] hidden xl:flex flex-col overflow-y-auto scrollbar-hide">
          ...
          <div className="p-8 flex flex-col gap-6">
            <h4 className="font-black text-[10px] uppercase tracking-widest text-[#3b82f6]">
              Input Payload
            </h4>
            ...
            <h4 className="font-black text-[10px] uppercase tracking-widest text-emerald-500">
              Model Response
            </h4>
            <div className="bg-[#0a0c10] border border-[#30363d] rounded-xl p-4 font-mono text-[10px] text-slate-400 leading-normal">
              <pre>
