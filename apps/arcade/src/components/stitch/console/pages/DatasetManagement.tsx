    ...
    <div className="flex-1 flex flex-col h-full overflow-hidden relative bg-[#101622] font-sans">
      <header className="h-16 border-b border-[#3b4354] bg-[#111318] flex items-center justify-between px-6 shrink-0 z-10">
        <div className="flex items-center gap-2">
          ...
          <span className="material-symbols-outlined text-[#9da6b9] text-[16px]">
            chevron_right
          </span>
      ...
      <main className="flex-1 overflow-y-auto p-8 scrollbar-hide">
        <div className="max-w-[1600px] mx-auto flex flex-col gap-8">
          <div className="flex flex-wrap justify-between items-end gap-4">
            ...
            <button
              type="button"
              className="flex items-center gap-2 px-6 py-3 bg-[#135bec] hover:bg-blue-600 text-white rounded-lg font-black uppercase tracking-widest text-xs shadow-lg shadow-blue-500/20 transition-all"
            >
            ...
            {[
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  {stat.label === "Index Status" && (
                    <span className="size-2 rounded-full bg-emerald-500 animate-pulse"></span>
                  )}
                </div>
                <div
                  className={`absolute bottom-0 left-0 h-1 bg-${stat.color}-500 w-full opacity-30`}
                ></div>
              </div>
            ))}
          </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <div className="relative group">
                    <span className="material-symbols-outlined absolute left-2.5 top-1/2 -translate-y-1/2 text-[#9da6b9] text-[18px] group-focus-within:text-[#135bec]">
                      search
                    </span>
                    <input
                      className="bg-[#1c1f27] border border-[#3b4354] text-white text-xs rounded-lg pl-9 pr-3 py-2 focus:ring-1 focus:ring-[#135bec] outline-none w-48"
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#9da6b9] text-xs">
                      Supports Stax, S3, Google Drive, or CSV uploads.
                    </p>
                  </div>
                </div>
                <button
                  type="button"
                  className="px-6 py-2.5 bg-[#282e39] hover:bg-[#323945] text-white text-[10px] font-black uppercase tracking-widest border border-[#3b4354] rounded-lg transition-all"
                >
                  Configure Connector
                </button>
              </div>
              ...
              <div className="bg-[#1c1f27] border border-[#3b4354] rounded-xl flex flex-col h-full shadow-sm">
                <div className="p-5 border-b border-[#3b4354] bg-[#161920] flex items-center justify-between px-6">
                  <h3 className="text-white font-black text-xs uppercase tracking-widest flex items-center gap-2">
                    <span className="material-symbols-outlined text-[#135bec] text-lg">
                      science
                    </span>
                    Retrieval Simulator
                  </h3>
                  <span className="text-[10px] text-[#9da6b9] bg-[#282e39] px-2 py-0.5 rounded font-black uppercase">
                    Preview
                  </span>
                </div>
                <div className="p-6 flex flex-col gap-6">
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="relative group">
                      <textarea
                        className="w-full bg-[#0d1117] border border-[#3b4354] rounded-lg p-4 text-xs text-white focus:ring-1 focus:ring-[#135bec] outline-none h-24 resize-none transition-all"
                    ...
                    {[
                      {
                        score: "0.92",
                        src: "Stax_KB_v2",
                        txt: "To reset your API key, navigate to the User Settings panel...",
                      },
                      {
                        score: "0.78",
                        src: "Support_Q3",
                        txt: "User reported issues with API key rotation. Engineering confirmed...",
                      },
                    ].map((res) => (
                      <div
                        key={res.src}
                        className="bg-[#0d1117] border border-[#3b4354] rounded-xl p-4 relative group hover:border-[#135bec]/50 transition-all"
                      >
                        <div className="absolute top-3 right-3 bg-[#135bec]/10 text-[#135bec] text-[10px] font-black px-2 py-0.5 rounded font-mono border border-[#135bec]/20">
                          {res.score}
                        </div>
