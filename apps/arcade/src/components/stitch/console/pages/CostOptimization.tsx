    ...
    <div className="flex-1 flex flex-col h-full overflow-hidden relative bg-[#101622] font-sans">
      <header className="flex-none h-16 border-b border-[#2e3646] flex items-center justify-between px-8 bg-[#111318]/50 backdrop-blur-sm z-10">
        <div className="flex flex-col">
          <h2 className="text-white text-lg font-bold uppercase tracking-widest text-[#135bec]">
            Cost & Model Optimization
          </h2>
          <p className="text-[#9da6b9] text-[10px] font-bold uppercase tracking-wide">
            Financial governance and model switching
          </p>
        </div>
              ...
              <div className="p-8 rounded-xl bg-[#1c1f2b] border border-[#2e3646] shadow-sm">
                <div className="flex flex-wrap items-center justify-between mb-8 gap-4">
                  <div>
                    ...
                    <p className="text-[#9da6b9] text-xs font-medium uppercase tracking-wide mt-1">
                      Forecasted spend based on active model config.
                    </p>
                  </div>
                  <div className="flex bg-[#111318] p-1 rounded-lg border border-white/5 text-[10px] font-bold uppercase tracking-widest">
                    ...
                    <button
                      type="button"
                      className="px-4 py-2 rounded-md text-[#9da6b9] hover:text-white transition-colors"
                    >
                      Monthly
                    </button>
                  </div>
                ...
                <div className="h-64 flex items-end gap-3 px-4 border-b border-[#2e3646] pb-4">
                  {Array.from({ length: 12 }).map((_, i) => (
                    <div
                      key={i}
                      className="flex-1 bg-[#135bec]/20 hover:bg-[#135bec]/40 transition-all rounded-t relative group"
                      style={{ height: `${Math.random() * 80 + 10}%` }}
                    >
                      <div
                        className={`absolute bottom-0 left-0 w-full bg-[#135bec] rounded-t ${i > 8 ? "opacity-30" : ""}`}
                        style={{ height: "60%" }}
                      ></div>
                    </div>
                  ))}
              ...
              <div className="p-8 rounded-xl bg-[#1c1f2b] border border-[#2e3646] shadow-sm">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-[#9da6b9] text-xs font-medium uppercase tracking-wide mt-1">
                      Estimate savings by switching default models.
                    </p>
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="p-8 rounded-2xl bg-emerald-500/5 border border-emerald-500/10 flex flex-col items-center text-center">
                    ...
                    <button
                      type="button"
                      className="mt-6 w-full py-4 bg-emerald-500 hover:bg-emerald-400 text-white text-[10px] font-black uppercase tracking-widest rounded-xl transition-all shadow-lg shadow-emerald-500/20"
                    >
              ...
              <div className="p-8 rounded-xl bg-[#1c1f2b] border border-[#2e3646] shadow-sm">
                ...
                <div className="space-y-6">
                  <div className="relative">
                    ...
                    <span className="absolute right-4 top-1/2 -translate-y-1/2 material-symbols-outlined text-[#9da6b9] pointer-events-none">
                      expand_more
                    </span>
                  </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-slate-500 text-[9px] font-medium uppercase mt-1">
                        Stops non-critical agents
                      </p>
                    </div>
                    <div className="w-10 h-5 bg-[#135bec] rounded-full relative">
                  ...
                  <div className="relative">
                    ...
                    <input
                      className="w-full bg-[#111318] border border-[#2e3646] rounded-xl py-3 pl-8 pr-12 text-white font-mono text-sm outline-none"
                      value="500"
                    />
                    <span className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-600 font-black text-[10px]">
                      USD
                    </span>
                  </div>
                </div>
