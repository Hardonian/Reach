...
const artifacts: Artifact[] = [
  {
    name: "agent-pack-v2.4.0.tar.gz",
    type: "Agent Pack",
    size: "14.2 MB",
    status: "Signed",
    created: "2h ago",
    hash: "sha256:a3f1...b92e",
  ...
  {
    name: "eval-dataset-jan.parquet",
    type: "Dataset",
    size: "842 MB",
    status: "Unsigned",
    created: "1d ago",
    hash: "sha256:c7a9...d01f",
  ...
  {
    name: "runner-snapshot-prod.img",
    type: "Runner Image",
    size: "2.1 GB",
    status: "Signed",
    created: "3d ago",
    hash: "sha256:f82b...7c44",
    retentionTier: "extended",
    retentionDays: 90,
  ...
  {
    name: "governance-policy-v3.json",
    type: "Policy Bundle",
    size: "48 KB",
    status: "Signed",
    created: "5d ago",
    hash: "sha256:09e3...a15d",
    retentionTier: "short",
    retentionDays: 7,
  ...
  {
    name: "test-fixtures-archive.zip",
    type: "Dataset",
    size: "128 MB",
    status: "Expired",
    created: "45d ago",
    hash: "sha256:b4e7...c89a",
    retentionTier: "short",
    retentionDays: 7,
      ...
      <header className="sticky top-0 z-50 flex items-center justify-between border-b border-[#282e39] bg-[#111318] px-10 py-5">
        <div className="flex flex-col">
          ...
          <p className="text-[#9da6b9] text-[10px] font-bold uppercase tracking-wide">
            Signed build outputs, snapshots & policy bundles
          </p>
        </div>
      ...
      <main className="flex-1 p-8 md:p-12 max-w-[1600px] mx-auto w-full flex flex-col gap-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            {
              label: "Expired",
              value: String(artifacts.filter((a) => a.expired).length),
              color: "red",
            },
            ...
            <tbody className="divide-y divide-slate-800 text-xs">
              ...
              {filtered.map((artifact) => {
                ...
                return (
                  <tr
                    key={artifact.name}
                    className={`hover:bg-white/5 transition-colors group ${artifact.expired ? "opacity-60" : ""}`}
                  >
                    ...
                    <td className="px-8 py-5">
                      <span
                        className={`px-2 py-0.5 rounded font-bold uppercase tracking-widest text-[9px] bg-${tier.color}-500/10 text-${tier.color}-400 border border-${tier.color}-500/20`}
                      >
                        {tier.label}
                      </span>
                    </td>
                    ...
                    <td className="px-8 py-5 font-mono text-slate-500 text-[10px]">
                      {artifact.hash}
                    </td>
                    <td className="px-8 py-5 text-right">
                      <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button
                          ...
                          title={
                            artifact.expired
                              ? "Artifact expired — download unavailable"
                              : "Download"
                          }
                        >
