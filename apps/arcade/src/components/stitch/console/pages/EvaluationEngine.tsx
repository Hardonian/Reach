...
export function EvaluationEngine() {
  ...
  const history = [
    ...
    },
    {
      version: "v2.3.9",
      time: "2h ago",
      title: "Increased Latency tolerance",
      user: "Mike R.",
    },
    {
      version: "v2.3.8",
      time: "Yesterday",
      title: "Baseline grounding adjustment",
      user: "Sarah J.",
    },
    {
      version: "v2.3.7",
      time: "2 days ago",
      title: "Rollback: Cost optimization",
      user: "System",
    },
  ];
        ...
        <aside className="w-72 bg-[#0d1117] border-r border-slate-800 flex flex-col overflow-y-auto shrink-0 scrollbar-hide">
          <div className="p-4 border-b border-slate-800 sticky top-0 bg-[#0d1117] z-10">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                type="button"
                className="text-[#135bec] hover:text-blue-400 text-xs font-semibold"
              >
                View All
              </button>
            </div>
            <div className="relative group">
              <span className="material-symbols-outlined absolute left-2 top-2 text-slate-500 text-sm group-focus-within:text-[#135bec]">
                search
              </span>
              <input
                className="w-full bg-[#1c2333] border border-slate-700 rounded text-xs text-white pl-8 pr-2 py-2 focus:outline-none focus:ring-1 focus:ring-[#135bec]"
          ...
          <div className="flex flex-col">
            {history.map((item) => (
              <div
                key={item.version}
                className={`p-4 border-l-2 cursor-pointer transition-colors ${item.active ? "border-[#135bec] bg-[#135bec]/5" : "border-l-transparent border-b border-slate-800/50 hover:bg-[#1c2333]"}`}
              >
                <div className="flex items-center justify-between mb-1">
                  <span
                    className={`${item.active ? "text-[#135bec]" : "text-slate-400"} text-xs font-bold`}
                  >
              ...
              <div className="bg-[#1c2333] rounded-xl border border-slate-700 overflow-hidden shadow-sm">
                <div className="p-4 border-b border-slate-700 bg-[#161b28] flex justify-between items-center px-6">
                  ...
                  <div className="flex items-center gap-3">
                    <span className="text-[#9da6b9] text-[10px] font-bold uppercase tracking-widest">
                      Lock Weights
                    </span>
                    <button
                      type="button"
                      aria-label="Lock Weights"
                      className="relative inline-flex h-5 w-9 items-center rounded-full bg-slate-700"
                    >
                      <span className="inline-block h-3 w-3 transform rounded-full bg-white translate-x-1 transition"></span>
                    </button>
                  </div>
                </div>
                ...
                <div className="px-8 py-4 bg-[#161b28] border-t border-slate-700 flex justify-end gap-3 text-xs font-bold uppercase tracking-widest">
                  ...
                  <button
                    type="button"
                    className="bg-[#135bec] hover:bg-blue-600 text-white rounded px-6 py-2.5 shadow-lg shadow-blue-500/20"
                  >
                    Apply Changes
                  </button>
                </div>
              ...
              <div className="bg-[#1c2333] rounded-xl border border-slate-700 p-8">
                <div className="flex justify-between items-center mb-6">
                  <div>
                    ...
                    <p className="text-slate-500 text-xs mt-1">
                      Weighted performance over the last 30 days
                    </p>
                  </div>
                ...
                <div className="w-full h-48 bg-linear-to-b from-[#135bec]/5 to-transparent rounded border border-slate-700 relative overflow-hidden flex items-end px-2">
                  ...
                  <div className="absolute inset-0 flex items-end">
                    ...
                    >
                      <path
                        d="M0,150 Q250,140 500,80 T1000,50"
                        fill="none"
                        stroke="#135bec"
                        strokeWidth="3"
                      />
                      <path
                        d="M0,180 Q250,160 500,120 T1000,90"
                        fill="none"
                        stroke="#a855f7"
                        strokeWidth="2"
                        strokeDasharray="6"
            ...
            <div className="col-span-12 xl:col-span-4 flex flex-col gap-6">
              ...
              <div className="bg-[#1c2333] rounded-xl border border-slate-700 flex flex-col">
                <div className="p-4 border-b border-slate-700 flex justify-between items-center px-6 bg-[#161b28]">
                  ...
                  <span className="bg-emerald-500/10 text-emerald-500 border border-emerald-500/20 text-[10px] font-black px-2 py-0.5 rounded tracking-widest uppercase">
                    Passed
                  </span>
                </div>
              ...
              <div className="bg-[#1c2333] rounded-xl border border-slate-700 flex flex-col flex-1 overflow-hidden shadow-sm">
                <div className="p-4 border-b border-slate-700 px-6 bg-[#161b28]">
                  ...
                  <p className="text-slate-500 text-[10px] mt-1 font-medium uppercase tracking-wide">
                    Drift detection against policy
                  </p>
                </div>
                  ...
                  <table className="w-full text-left text-sm">
                    ...
                    <tbody className="divide-y divide-slate-800 text-xs">
                      {[
                        ...
                        <tr
                          key={row.m}
                          className={`hover:bg-white/5 transition-colors ${row.w ? "bg-red-500/5" : ""}`}
                        >
