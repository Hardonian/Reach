  ...
  const pillars = [
      ...
      nodes: [
        {
          ...
          route: "/console",
          role: "Admin",
          desc: "Centralized dashboard for orchestration control.",
          access: "Admin",
        },
        {
          name: "Runners",
          path: ROUTES.CONSOLE.RUNNERS,
          route: "/runners",
          role: "Admin",
          desc: "Manage active runtime containers and job queues.",
          access: "Admin",
        },
        {
          name: "Agents",
          path: ROUTES.CONSOLE.AGENTS.HOME,
          route: "/agents",
          role: "User",
          desc: "Configure AI agent behaviors and personality.",
          access: "User",
        },
        {
          name: "Traces",
          path: ROUTES.CONSOLE.TRACES,
          route: "/traces",
          role: "User",
          desc: "Inspect execution traces and step reasoning.",
          access: "User",
        },
      ],
    },
      ...
      nodes: [
        {
          ...
          path: ROUTES.CONSOLE.GOVERNANCE.HOME,
          route: "/governance",
          role: "Admin",
          desc: "Define and enforce safety guardrails.",
          access: "Admin",
        },
        {
          name: "QA & Testing",
          path: ROUTES.CONSOLE.EVALUATION.HOME,
          route: "/evaluation",
          role: "User",
          desc: "Run regression tests and performance metrics.",
          access: "User",
        },
        {
          name: "Cost Management",
          path: ROUTES.CONSOLE.COST.HOME,
          route: "/cost",
          role: "Admin",
          desc: "Track compute usage and token consumption.",
          access: "Admin",
        },
        {
          name: "Billing Control",
          path: ROUTES.CONSOLE.BILLING,
          route: "/billing",
          role: "Admin",
          desc: "Monetization and department chargebacks.",
          access: "Admin",
        },
        {
          name: "Safety Monitor",
          path: ROUTES.CONSOLE.SAFETY,
          route: "/safety",
          role: "User",
          desc: "Adversarial safety and trust monitoring.",
          access: "User",
        },
      ],
    },
    {
      ...
      nodes: [
        {
          name: "Training Data",
          path: ROUTES.CONSOLE.DATASETS,
          route: "/datasets",
          role: "User",
          desc: "Manage RAG knowledge bases and fine-tuning.",
          access: "User",
        },
        {
          name: "Integrations",
          path: ROUTES.CONSOLE.INTEGRATIONS,
          route: "/integrations",
          role: "Admin",
          desc: "API connectors and secure webhooks.",
          access: "Admin",
        },
        {
          name: "Plugin Manager",
          path: ROUTES.CONSOLE.ECOSYSTEM.HOME,
          route: "/ecosystem",
          role: "User",
          desc: "Install and manage capability plugins.",
          access: "User",
        },
        {
          name: "Artifacts",
          path: ROUTES.CONSOLE.ARTIFACTS,
          route: "/artifacts",
          role: "User",
          desc: "Repository of agent-generated outputs.",
          access: "User",
        },
      ],
    },
    {
      ...
      nodes: [
        {
          name: "Documentation",
          path: ROUTES.WEB.ARCHITECTURE,
          route: "/architecture",
          role: "Public",
          desc: "Full system documentation and diagrams.",
          access: "Public",
        },
        {
          name: "Transparency",
          path: ROUTES.WEB.TRANSPARENCY,
          route: "/transparency",
          role: "Public",
          desc: "Public-facing immutable audit logs.",
          access: "Public",
        },
        {
          name: "Marketplace",
          ...
          route: "/marketplace",
          role: "User",
          desc: "Discover and deploy community agents.",
          access: "User",
        },
        {
          name: "Account Settings",
          path: ROUTES.CONSOLE.PROFILE,
          route: "/profile",
          role: "User",
          desc: "Manage preferences and security keys.",
          access: "User",
        },
      ],
    },
      ...
      <header className="h-16 border-b border-[#283039] bg-[#101922]/80 backdrop-blur flex items-center justify-between px-10 shrink-0 z-20">
        ...
        <div className="flex items-center gap-4">
          <div className="bg-[#1a242f] border border-[#283039] rounded px-3 py-1 flex items-center gap-2">
            ...
            <span className="text-[10px] font-mono text-[#9dabb9] uppercase tracking-widest">
              System Operational
            </span>
          </div>
        </div>
                  ...
                  {pillar.nodes.map((node) => (
                    ...
                    >
                      <div className="flex justify-between items-start mb-4">
                        <div className="font-mono text-[#137fec] text-[10px] font-black bg-[#137fec]/10 px-2 py-1 rounded border border-[#137fec]/20 tracking-tighter">
                          {node.route}
                        </div>
                        <span
                          className={`text-[9px] font-black uppercase tracking-widest px-2 py-0.5 rounded border ${node.access === "Admin" ? "bg-purple-500/10 text-purple-400 border-purple-500/20" : node.access === "Public" ? "bg-blue-400/10 text-blue-300 border-blue-400/20" : "bg-emerald-500/10 text-emerald-400 border-emerald-500/20"}`}
                        >
                          {node.role}
                        </span>
                      </div>
                      <h3 className="text-white font-black text-sm uppercase tracking-widest group-hover:text-[#137fec] transition-colors">
                        {node.name}
                      </h3>
                      <p className="text-[#9dabb9] text-xs font-medium leading-relaxed mt-2 mb-6 group-hover:text-slate-300 transition-colors">
                        {node.desc}
                      </p>
