  ...
  const templates = [
    {
      ...
      version: "v2.4.0",
      org: "ReadyLayer Official",
      rating: 4.9,
      desc: "Autonomous agent designed for anomaly detection in financial reports. Integrates with Quickbooks and Xero APIs.",
      deploys: "12k deploys",
      icon: "query_stats",
      color: "blue",
    },
    {
      ...
      org: "ReadyLayer Official",
      rating: 4.7,
      desc: "First-line support agent that classifies tickets, drafts responses, and escalates complex issues to human agents.",
      deploys: "8.5k deploys",
      icon: "support_agent",
      color: "purple",
    },
    {
      ...
      org: "Community",
      rating: 4.8,
      desc: "Automatically reviews PRs for style violations, security vulnerabilities, and test coverage.",
      deploys: "5.2k deploys",
      icon: "code",
      color: "green",
    },
  ];
  ...
  const runners = [
    {
      ...
      tag: "HIPAA",
      desc: "Strict PII redaction and audit logs enabled by default.",
      icon: "local_hospital",
      color: "rose",
    },
    {
      name: "FinTech Secure",
      tag: "SOC2",
      desc: "Isolated memory containers with zero-retention policies.",
    ...
    },
    {
      ...
      tag: "PCI-DSS",
      desc: "Transaction monitoring and fraud detection preset.",
      icon: "shopping_cart",
      color: "cyan",
    },
    {
      name: "EU Compliance",
      tag: "GDPR",
      desc: "Data residency locks and user consent workflows.",
      icon: "public",
      color: "emerald",
    },
  ];
    ...
    <div className="flex flex-1 overflow-hidden bg-[#101622]">
      ...
      <aside className="hidden lg:flex w-64 flex-col border-r border-[#283040] bg-[#101622] overflow-y-auto">
        <div className="p-4 space-y-6">
          <div>
            <h3 className="text-xs font-semibold text-[#9da6b9] uppercase tracking-wider mb-3">
              Browse
            </h3>
          ...
          <div className="mt-auto pt-6">
            <div className="rounded-xl bg-linear-to-br from-[#1a2230] to-[#135bec]/10 border border-[#283040] p-4">
              <div className="flex items-start justify-between mb-2">
                ...
                <span className="text-[10px] font-bold bg-[#135bec]/20 text-[#135bec] px-2 py-0.5 rounded">
                  NEW
                </span>
              </div>
              ...
              <button
                type="button"
                className="w-full py-1.5 rounded-lg bg-[#1a2230] border border-[#283040] hover:bg-[#283040] text-xs font-medium text-white transition-colors"
              >
                Learn More
              </button>
            </div>
          ...
          <section className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="relative flex-1 group">
                ...
                <input
                  className="block w-full pl-10 pr-4 py-3 rounded-lg bg-[#1a2230] border border-[#283040] text-white placeholder-[#9da6b9] focus:ring-2 focus:ring-[#135bec]/50 focus:border-[#135bec] outline-none transition-all"
                  placeholder="Search templates, runners, and integrations..."
                  type="text"
                />
                <div className="absolute inset-y-0 right-0 pr-2 flex items-center">
                  <kbd className="hidden sm:inline-block px-2 py-0.5 rounded bg-[#101622] border border-[#283040] text-xs text-[#9da6b9]">
                    ⌘K
                  </kbd>
                </div>
              </div>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
              {templates.map((card) => (
                <div
                  key={card.title}
                  className="group relative flex flex-col rounded-xl border border-[#283040] bg-[#1a2230] p-5 hover:border-[#135bec]/50 hover:shadow-[0_0_20px_-10px_rgba(19,91,236,0.3)] transition-all duration-300"
                >
                  ...
                  <div className="mt-auto flex items-center justify-between pt-4 border-t border-[#283040]/50">
                    ...
                    <button
                      type="button"
                      className="px-3 py-1.5 rounded-lg bg-white text-[#101622] text-xs font-bold hover:bg-[#135bec] hover:text-white transition-colors"
                    >
                      Deploy
                    </button>
                  </div>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {runners.map((runner) => (
                <div
                  key={runner.name}
                  className="group flex flex-col p-4 rounded-xl border border-[#283040] bg-linear-to-br from-[#1a2230] to-[#101622] hover:from-[#1a2230] hover:to-[#1a2230] hover:border-[#135bec]/30 transition-all cursor-pointer"
                >
          ...
          <footer className="py-10 border-t border-[#283040]">
            <div className="rounded-2xl bg-linear-to-r from-[#135bec]/20 via-[#1a2230] to-[#1a2230] border border-[#283040] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden">
              ...
              <div className="relative z-10 flex gap-4">
                <button
                  type="button"
                  className="px-5 py-2.5 rounded-lg border border-[#283040] bg-[#101622] text-white text-sm font-medium hover:bg-[#283040] transition-colors"
                >
                  Request Template
                </button>
                <button
                  type="button"
                  className="px-5 py-2.5 rounded-lg bg-[#135bec] text-white text-sm font-bold hover:bg-[#135bec]/90 transition-colors shadow-lg shadow-[#135bec]/20"
                >
                  Build Custom Agent
                </button>
              </div>
