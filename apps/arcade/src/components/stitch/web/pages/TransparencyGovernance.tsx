        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-8 md:items-end relative z-10">
          <div className="flex flex-col gap-4 max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black leading-tight tracking-tight text-slate-900 dark:text-white">
              Transparency & <br />
              <span className="text-transparent bg-clip-text bg-linear-to-r from-[#135bec] to-blue-400">
                Governance Posture
              </span>
            </h1>
          ...
          <div className="flex flex-col gap-2">
            <div className="text-sm font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider text-right">
              Last Verified Audit
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={card.title}
                className="group relative flex flex-col gap-4 p-6 rounded-xl border border-slate-200 dark:border-[#3b4354] bg-white dark:bg-[#1c1f27] hover:border-[#135bec]/50 transition-all duration-300 shadow-sm hover:shadow-lg hover:shadow-[#135bec]/5"
              >
                ...
                {[
                  {
                    ...
                    desc: "Auto-trip on anomaly detection > 3σ",
                    status: "ARMED",
                    color: "emerald",
                  },
                  {
                    name: "Degraded Mode",
                    desc: "Safe-fail protocols for API outages",
                    status: "STANDBY",
                    color: "slate",
                  },
                  {
                    name: "Human-in-the-Loop",
                    desc: "Required for high-stakes financial ops",
                    status: "ACTIVE",
                    color: "emerald",
                  },
                ].map((item) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-2 h-2 rounded-full ${item.color === "emerald" ? "bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.6)]" : "bg-slate-500"}`}
                      ></div>
                      <div>
                    ...
                    <span
                      className={`px-2 py-1 rounded ${item.color === "emerald" ? "bg-emerald-500/20 text-emerald-400" : "bg-slate-700 text-slate-300"} text-xs font-mono font-bold`}
                    >
                      {item.status}
                    </span>
                  </div>
              ...
              {[
                {
                  ...
                  sub: "Sanitization & Tokenization",
                  icon: "input",
                  complete: true,
                },
                {
                  title: "Intent Classification",
                  sub: "Weighted Scoring Analysis",
                  icon: "psychology",
                  active: true,
                  progress: 85,
                },
                {
                  ...
                  sub: "RLS & Policy Validation",
                  icon: "gavel",
                },
                {
                  title: "Immutable Log",
                  sub: "Final State Commitment",
                  icon: "receipt_long",
                },
              ].map((step, idx, arr) => (
                <div
                  ...
                  <div className="flex flex-col items-center">
                    <div
                      className={`w-10 h-10 rounded-full flex items-center justify-center border transition-all ${
                        step.active
                          ? "bg-[#135bec]/20 border-[#135bec] text-[#135bec] shadow-[0_0_15px_rgba(19,91,236,0.3)]"
                    ...
                    {idx < arr.length - 1 && (
                      <div
                        className={`h-12 w-0.5 my-2 transition-colors ${
                          step.active
                            ? "bg-linear-to-b from-[#135bec] to-slate-200 dark:to-slate-700"
