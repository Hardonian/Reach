...
export interface ToolAuditRecord {
  ...
  input_hash: string;
  output_hash?: string;
  status: 'pending' | 'success' | 'error' | 'timeout' | 'rate_limited' | 'permission_denied' | 'circuit_open';
...
export const ToolDefinitionSchema = z.object({
  ...
  version: z.string(),
  permission_scope: z.array(z.enum(['read', 'write', 'execute', 'admin', 'network', 'filesystem', 'process'])),
  required_permissions: z.array(z.enum(['read', 'write', 'execute', 'admin', 'network', 'filesystem', 'process'])),
