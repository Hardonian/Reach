...
export function isRetryableError(error: Error, config: RetryConfig): boolean {
  ...
  return config.retryable_errors.some(re => 
    errorStr.includes(re.toLowerCase()) || errorStr.includes(re.replace('_', ' '))
  );
}
...
export const MODEL_PRICING: ModelPricing[] = [
  { provider: 'openai', model: 'gpt-4o', input_cost_per_1k: 0.0025, output_cost_per_1k: 0.01 },
  { provider: 'openai', model: 'gpt-4o-mini', input_cost_per_1k: 0.00015, output_cost_per_1k: 0.0006 },
  { provider: 'openai', model: 'gpt-4-turbo', input_cost_per_1k: 0.01, output_cost_per_1k: 0.03 },
  { provider: 'anthropic', model: 'claude-3-5-sonnet', input_cost_per_1k: 0.003, output_cost_per_1k: 0.015 },
  { provider: 'anthropic', model: 'claude-3-opus', input_cost_per_1k: 0.015, output_cost_per_1k: 0.075 },
  { provider: 'google', model: 'gemini-1.5-pro', input_cost_per_1k: 0.00125, output_cost_per_1k: 0.005 },
  { provider: 'google', model: 'gemini-1.5-flash', input_cost_per_1k: 0.000075, output_cost_per_1k: 0.0003 },
  { provider: 'mistral', model: 'mistral-large', input_cost_per_1k: 0.002, output_cost_per_1k: 0.006 },
];
