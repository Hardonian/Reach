...
export const TEMPLATES: Template[] = [
  {
    ...
    description:
      "Runs 12 checks covering tool reliability, policy gates, output schema, and latency budget. The recommended starting point for any new agent.",
    icon: "▶",
    category: "readiness",
    difficulty: "beginner",
    checks: [
  ...
  },
  {
    ...
    description:
      "Validates every tool call against your defined rules. Catches privilege escalation, unguarded network calls, and banned tool patterns.",
    icon: "🛡",
    category: "safety",
  ...
  },
  {
    ...
    description:
      "Compares your current run against a saved baseline. Surfaces behavioral diffs in output schema, latency, and tool usage patterns.",
    icon: "⟳",
    category: "regression",
    difficulty: "beginner",
    checks: [
  ...
  },
  {
    ...
    description:
      "Captures a full execution trace without enforcing any rules. Use this to understand agent behavior before writing checks.",
    icon: "🔍",
    category: "tracing",
    difficulty: "beginner",
    checks: [
  ...
  },
  {
    ...
    description:
      "CI/CD-ready check that fails if the agent score drops below your threshold. Drop into GitHub Actions in one step.",
    icon: "🚀",
    category: "release",
    difficulty: "intermediate",
    checks: [
  ...
  },
  {
    ...
    description:
      "Enforces circuit breakers, slippage limits, and multi-sig approval for large transactions. Critical for agents handling treasury or trading.",
    icon: "💸",
    category: "release",
    difficulty: "advanced",
    checks: [
  ...
  },
  {
    ...
    description:
      "Monitors sentiment drift, hallucination rates, and knowledge base grounding. Ensures your agent stays helpful and accurate.",
    icon: "🎧",
    category: "readiness",
    difficulty: "intermediate",
    checks: [
  ...
  },
  {
    ...
    description:
      "Automated privacy audits and data exfiltration patterns. Blocks agents from accessing or leaking restricted PII.",
    icon: "🛡",
    category: "safety",
    difficulty: "advanced",
    checks: [
  ...
  },
  {
    ...
    description:
      "Sync verification between Shopify, Amazon, and ERP. Prevents overselling and price disparity errors.",
    icon: "🛒",
    category: "regression",
    difficulty: "intermediate",
    checks: [
  ...
  },
  {
    ...
    description:
      "Standardized checks for internal HR, IT, and legal bots. Enforces SSO, corporate policy, and budget caps.",
    icon: "🏢",
    category: "readiness",
    difficulty: "beginner",
    checks: [
