      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section className="bg-accent/10 border border-accent/20 p-12 rounded-3xl">
          ...
          <div className="flex gap-4">
            <a href="mailto:security@reach.dev" className="btn-primary py-3 px-8">Report via Email</a>
            <Link href="/docs/security" className="btn-secondary py-3 px-8">Security Docs</Link>
          </div>
        </section>

        <footer className="mt-20 text-center text-sm text-gray-500">
          <p>Looking for a SOC2 report or pentest results? <Link href="/support" className="text-accent hover:underline">Contact our Enterprise team</Link>.</p>
        </footer>
      </div>
    </div>
  );
