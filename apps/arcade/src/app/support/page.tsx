...
export const metadata: Metadata = {
  ...
  description:
    "Get help with ReadyLayer. Explore self-service docs, contact support, or check system status.",
};
  ...
  const supportTiers = [
    {
      ...
      description:
        "Ideal for developers and hobbyists. Best-effort support via GitHub and Discord.",
      features: [
        "GitHub Discussions",
        "Community Discord",
    ...
    <div className="section-container py-16">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16 text-center">
          <Link
            href="/docs"
            className="card p-8 border border-white/5 rounded-2xl hover:bg-white/5 transition-colors"
          >
          ...
          {supportTiers.map((tier) => (
            ...
            >
              ...
              <Link
                ...
                className={
                  tier.highlighted
                    ? "btn-primary text-center py-3"
                    : "btn-secondary text-center py-3"
                }
              >
                {tier.cta}
              </Link>
