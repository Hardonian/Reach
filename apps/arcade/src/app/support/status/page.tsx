...
export default function SystemStatusPage() {
  ...
  const incidents = [
    ...
    },
    {
      ...
      resolved: true,
      description: "Upgraded deterministic core to v2.4.0. Completed with zero downtime.",
    },
  ];
          ...
          <div className="mt-8 pt-8 border-t border-white/5 grid md:grid-cols-2 gap-8 text-left max-w-2xl mx-auto">
            <div>
              ...
              <p className="text-xs text-gray-400">
                Major outages are broadcast via our official 𝕏 feed and the ReadyLayer status
                Discord channel. Critical security patches are coordinated via the security mailing
                list.
              </p>
            </div>
            <div>
              ...
              <p className="text-xs text-gray-400">
                ...
                <a href="https://github.com" className="text-accent hover:underline ml-1">
