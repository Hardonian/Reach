        ...
        <div className="space-y-6">
          ...
          <section className="card gradient-border">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Open the playground and run a pre-built check. It takes less than 30 seconds to see a result.
            </p>
          ...
          <section className="card">
            ...
            <Link href={ROUTES.MONITORING} className="text-accent hover:underline text-sm font-medium">
          ...
          <section className="card gradient-border">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>→ <Link href={ROUTES.LAB} className="text-accent hover:underline">Experiment in Lab</Link> — Run side-by-side simulations</li>
              <li>→ <Link href={ROUTES.TRUST.HOME} className="text-accent hover:underline">Trust Center</Link> — Compliance and data hygiene</li>
            </ul>
          </section>
