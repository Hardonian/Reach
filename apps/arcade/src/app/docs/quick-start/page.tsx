...
export const metadata = {
  ...
  description:
    "Run your first readiness check in under 2 minutes. No installation required.",
};
    ...
    <div className="section-container py-8">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-gray-400 mb-2">
          Your first readiness check in under 2 minutes. Click through the lab
          or connect your CLI.
        </p>
        ...
        <div className="space-y-6">
          ...
          <section className="card gradient-border">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Open the playground and run a pre-built check. It takes less than
              30 seconds to see a result.
            </p>
            <Link
          ...
          <section className="card">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Every run outputs a score and fix suggestions. No manual guesswork
              required.
            </p>
            <div className="bg-black/50 p-4 rounded-lg font-mono text-sm space-y-1">
              ...
              <p className="text-gray-500">
                Fix: [HIGH] Tool timeout — set timeout_ms: 1500
              </p>
            </div>
          </section>
          ...
          <section className="card">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Run checks in your local environment. No permanent installation
              required.
            </p>
          ...
          <section className="card">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Block broken agents from merging. Add one YAML file to your GitHub
              repository.
            </p>
            <div className="bg-black/50 p-4 rounded-lg font-mono text-sm text-gray-300">
          ...
          <section className="card">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Track your agent health after deployment. Get alerts on drift or
              tool failures.
            </p>
            <Link
