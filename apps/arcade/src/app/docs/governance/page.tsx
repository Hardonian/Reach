        ...
        <div className="space-y-8">
          <section className="card">
            ...
            <p className="text-gray-400">
              Governance in ReadyLayer provides frameworks for controlling agent behavior, ensuring
              compliance with policies, and maintaining accountability. It encompasses access
              control, audit logging, policy enforcement, and human oversight.
            </p>
          </section>
          ...
          <section className="card">
            ...
            <div className="space-y-4 text-gray-400">
              <div>
                ...
                <p>
                  Policies are declarative rules that constrain agent behavior. They can be defined
                  at organization, project, or agent levels.
                </p>
              </div>
              <div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-black/30 p-4 rounded-lg">
                ...
                <p className="text-gray-400 text-sm">
                  Comprehensive logs of all agent actions, decisions, and data access.
                </p>
              </div>
              <div className="bg-black/30 p-4 rounded-lg">
                <h3 className="font-semibold text-white mb-2">Traceability</h3>
                <p className="text-gray-400 text-sm">
                  End-to-end tracking of request flow through multiple agents.
                </p>
              </div>
              <div className="bg-black/30 p-4 rounded-lg">
              ...
              <div className="bg-black/30 p-4 rounded-lg">
                ...
                <p className="text-gray-400 text-sm">
                  Configurable policies for data lifecycle management.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="card">
            ...
            <p className="text-gray-400 mb-4">Require human approval for critical decisions:</p>
            <div className="bg-black/50 p-4 rounded-lg font-mono text-sm text-gray-300">
              <p>{`steps:`}</p>
          ...
          <section className="card">
            ...
            <p className="text-gray-400 mb-4">Programmatically manage governance:</p>
            <ul className="space-y-2 text-gray-400">
              <li>
                • <code className="bg-black/50 px-2 py-1 rounded">POST /v1/policies</code> - Create
                policies
              </li>
              <li>
                • <code className="bg-black/50 px-2 py-1 rounded">GET /v1/audit/logs</code> - Query
                audit logs
              </li>
              <li>
                • <code className="bg-black/50 px-2 py-1 rounded">POST /v1/approvals</code> - Submit
                approvals
              </li>
              <li>
                • <code className="bg-black/50 px-2 py-1 rounded">GET /v1/compliance/report</code> -
                Generate reports
              </li>
            </ul>
          </section>
