    ...
    <div className="section-container py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-400 mb-8">
          Manage policies, compliance, and oversight for agent behavior and
          platform operations.
        </p>
        ...
        <div className="space-y-8">
          <section className="card">
            ...
            <p className="text-gray-400">
              Governance in ReadyLayer provides frameworks for controlling agent
              behavior, ensuring compliance with policies, and maintaining
              accountability. It encompasses access control, audit logging,
          ...
          <section className="card">
            ...
            <div className="space-y-4 text-gray-400">
              <div>
                ...
                <p>
                  Policies are declarative rules that constrain agent behavior.
                  They can be defined at organization, project, or agent levels.
                </p>
              </div>
              <div>
                ...
                <ul className="list-disc list-inside mt-2 space-y-1">
                  ...
                  <li>
                    Ethical policies (content restrictions, bias prevention)
                  </li>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-black/30 p-4 rounded-lg">
                ...
                <p className="text-gray-400 text-sm">
                  Comprehensive logs of all agent actions, decisions, and data
                  access.
                </p>
              </div>
              <div className="bg-black/30 p-4 rounded-lg">
