    ...
    <div className="space-y-12">
      <header>
        ...
        <p className="text-xl text-gray-400">
          ReadyLayer is built to be the execution layer for your entire stack. Connect to IDEs,
          cloud providers, and custom services via our standardized protocol.
        </p>
      </header>
      ...
      <section className="space-y-6">
        ...
        <div className="card bg-white/5 p-8 rounded-xl border border-white/10">
          ...
          <p className="text-sm text-gray-400 mb-6">
            The ReadyLayer VS Code extension provides integrated agent execution, real-time event
            logs, and pack management directly within your editor.
          </p>
          <ul className="grid md:grid-cols-2 gap-4 text-xs text-gray-500 mb-6">
            ...
            <li className="flex items-center gap-2">
              <span className="text-accent">→</span> Integrated ReadyLayer Doctor diagnostics
            </li>
            <li className="flex items-center gap-2">
              <span className="text-accent">→</span> In-editor deterministic replay
            </li>
            <li className="flex items-center gap-2">
              <span className="text-accent">→</span> Policy violation highlighting
            </li>
          </ul>
      ...
      <section className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="border border-white/5 p-6 rounded-xl hover:bg-white/5 transition-colors cursor-pointer">
            ...
            <p className="text-xs text-gray-500 mt-1">
              High-performance internal service communication with built-in capability guards.
            </p>
