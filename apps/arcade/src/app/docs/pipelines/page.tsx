    ...
    <div className="section-container py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-400 mb-8">
          Build multi-step workflows by connecting agents, tools, and data sources into executable pipelines.
        </p>
          ...
          <section className="card">
            ...
            <div className="space-y-4 text-gray-400">
              ...
              <div>
                ...
                <p>Data passed between steps using JSONPath expressions (e.g., $.steps.stepName.output).</p>
              </div>
              <div>
                <h3 className="font-semibold text-white">Triggers</h3>
                <p>Events that start pipeline execution: HTTP requests, schedules, webhooks, or agent outputs.</p>
              </div>
              <div>
          ...
          <section className="card">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="bg-black/30 p-4 rounded-lg">
                ...
                <p className="text-gray-400 text-sm">Iterate over collections or retry on failure.</p>
              </div>
            </div>
          </section>
