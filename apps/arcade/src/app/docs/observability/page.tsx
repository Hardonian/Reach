    ...
    <div className="space-y-8">
      <header>
        ...
        <p className="text-xl text-gray-400">
          Real-time insights into agent reasoning, tool usage, and policy
          compliance.
        </p>
      </header>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="card p-6 bg-white/5 border border-white/10 rounded-xl">
          ...
          <p className="text-sm text-gray-400">
            Every ReadyLayer node emits a high-fidelity OpenTelemetry event
            stream containing execution logs and metric labels.
          </p>
        </div>
        <div className="card p-6 bg-white/5 border border-white/10 rounded-xl">
          <h3 className="font-bold mb-2">Audit Capsules</h3>
          <p className="text-sm text-gray-400">
            Immutable snapshots of completed runs, including model inputs, tool
            outputs, and decision paths.
          </p>
        </div>
      </div>
