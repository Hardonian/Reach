    ...
    <div className="space-y-12">
      <header>
        ...
        <p className="text-xl text-gray-400">
          The ReadyLayer platform exposes a series of gRPC and REST APIs via its core services to
          enable orchestration, registry management, and session control.
        </p>
      </header>
        ...
        <div className="space-y-4">
          <div className="group border-l-4 border-accent bg-white/5 p-6 rounded-r-xl">
            ...
            <p className="text-sm text-gray-500">
              The primary execution interface. Handles pack submission, status polling, and event
              streaming.
            </p>
          </div>
          <div className="group border-l-4 border-blue-500 bg-white/5 p-6 rounded-r-xl">
            ...
            <p className="text-sm text-gray-500">
              Manages the collection of capabilities and connectors. Supports searching and
              versioning.
            </p>
          </div>
      ...
      <section className="space-y-6">
        ...
        <p className="text-gray-400 text-sm">
          All requests to the ReadyLayer API require a <strong>Reach-Token</strong> or Bearer
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-sm text-gray-400 mb-4">
              Submit an execution intent to the runner. Returns a <code>run_id</code> and a preview
              of the execution pack.
            </p>
