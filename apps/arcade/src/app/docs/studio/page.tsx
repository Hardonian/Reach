        ...
        <div className="space-y-8">
          <section className="card">
            ...
            <p className="text-gray-400">
              ReadyLayer Studio is an integrated development environment (IDE)
              for agents. It provides visual tools for designing pipelines,
              testing agents interactively, and debugging executions.
            </p>
          </section>
          ...
          <section className="card">
            ...
            <p className="text-gray-400">
              This opens Studio in your default browser at
          ...
          <section className="card">
            ...
            <div className="space-y-4 text-gray-400">
              <div>
                ...
                <p>
                  The main workspace for building pipelines. Drag agents from
                  the sidebar and connect them.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-white">Agent Library</h3>
                <p>
                  Browse available agents and tools. Search by name, tag, or
                  capability.
                </p>
              </div>
              <div>
                ...
                <p>
                  Configure selected agents, set parameters, and define
                  connections.
                </p>
              </div>
              <div>
                ...
                <p>
                  Send test inputs and view outputs. Inspect execution traces
                  and logs.
                </p>
              </div>
            </div>
          ...
          <section className="card">
            ...
            <div className="space-y-3 text-gray-400">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  Configure each agent&apos;s parameters in the properties panel
                </div>
              </div>
              <div className="flex items-start gap-3">
          ...
          <section className="card">
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                • <strong>Breakpoints:</strong> Pause execution at specific
                agents
              </li>
              <li>
              ...
              <li>
                • <strong>State Inspection:</strong> View data at any point in
                the pipeline
              </li>
              <li>
                • <strong>Log Viewer:</strong> Real-time logs with filtering and
                search
              </li>
              <li>
                • <strong>Replay:</strong> Re-run executions with the same
                inputs
              </li>
            </ul>
          </section>
