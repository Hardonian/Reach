        ...
        <div className="space-y-8">
          ...
          <section className="card">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-black/30 p-4 rounded-lg">
                ...
                <p className="text-gray-400 text-sm">Drag-and-drop interface for constructing agent workflows.</p>
              </div>
              <div className="bg-black/30 p-4 rounded-lg">
                <h3 className="font-semibold text-white mb-2">Interactive Testing</h3>
                <p className="text-gray-400 text-sm">Test agents in real-time with a built-in playground.</p>
              </div>
              <div className="bg-black/30 p-4 rounded-lg">
                <h3 className="font-semibold text-white mb-2">Debug Mode</h3>
                <p className="text-gray-400 text-sm">Step through executions and inspect state at each point.</p>
              </div>
              <div className="bg-black/30 p-4 rounded-lg">
                <h3 className="font-semibold text-white mb-2">Live Reload</h3>
                <p className="text-gray-400 text-sm">See changes instantly as you edit agent code.</p>
              </div>
            </div>
          </section>
          ...
          <section className="card">
            ...
            <p className="text-gray-400 mb-4">
              Start Studio from your project directory:
            </p>
          ...
          <section className="card">
            ...
            <div className="space-y-4 text-gray-400">
              <div>
                ...
                <p>The main workspace for building pipelines. Drag agents from the sidebar and connect them.</p>
              </div>
              <div>
          ...
          <section className="card">
            ...
            <p className="text-gray-400 mb-4">
              Studio provides powerful debugging tools:
            </p>
            <ul className="space-y-2 text-gray-400">
              <li>• <strong>Breakpoints:</strong> Pause execution at specific agents</li>
              <li>• <strong>Step Through:</strong> Execute one agent at a time</li>
              <li>• <strong>State Inspection:</strong> View data at any point in the pipeline</li>
              <li>• <strong>Log Viewer:</strong> Real-time logs with filtering and search</li>
              <li>• <strong>Replay:</strong> Re-run executions with the same inputs</li>
            </ul>
          </section>
