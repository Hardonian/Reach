  ...
  return (
    <div className="space-y-12">
      ...
      <section className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-400">Use our one-line installer for Termux environments.</p>
            <div className="bg-black/40 p-4 rounded-lg font-mono text-xs space-y-1">
      ...
      <section className="space-y-6">
        ...
        <p className="text-gray-400">Before running agentic workloads, verify your environment with <code>doctor</code>.</p>
        ...
        <div className="space-y-4">
          <div className="flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Choose from available execution templates like "Repo Audit" or "Skill Discovery".</p>
            </div>
          </div>
          <div className="flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Explicitly consent to the tool permissions required by the pack.</p>
            </div>
          </div>
          <div className="flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Watch the execution event log stream in real-time with full determinism.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <a href="/docs/architecture" className="card bg-white/5 p-6 rounded-xl border border-white/10 hover:border-accent/50 transition-colors">
            <h3 className="font-bold mb-1">Architecture Deep Dive</h3>
            <p className="text-xs text-gray-500">Learn about signed packs and capability firewalls.</p>
          </a>
      ...
      <footer className="pt-8 border-t border-border flex justify-between items-center text-sm">
        ...
        <div className="flex gap-4">
          <a href="/docs/mcp" className="text-accent hover:underline">MCP Integration →</a>
        </div>
      </footer>
    </div>
  );
