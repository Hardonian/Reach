          ...
          <ul className="space-y-4">
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <span className="text-sm text-gray-500">Every pack is hashed (SHA-256). Any tampering with the logic or manifest results in an immediate verification failure.</span>
              </div>
            </li>
            <li className="items-start gap-3 flex">
              ...
              <div>
                ...
                <span className="text-sm text-gray-500">Packs are signed by their creators or automation pipelines, allowing operators to restrict execution to trusted sources.</span>
              </div>
            </li>
          </ul>
        </div>
  ...
  timeout_seconds: 60`}
      ...
      <footer className="pt-8 border-t border-border flex justify-between items-center text-sm">
        ...
        <div className="flex gap-4">
          <a href="/docs/governance" className="text-accent hover:underline">Governance →</a>
        </div>
      </footer>
    </div>
  );
