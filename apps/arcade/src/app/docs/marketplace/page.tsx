          ...
          <section className="card">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-black/30 p-4 rounded-lg">
                ...
                <p className="text-gray-400 text-sm">Ready-to-deploy agents for specific tasks like data processing, customer support, or content generation.</p>
              </div>
              <div className="bg-black/30 p-4 rounded-lg">
                <h3 className="font-semibold text-white mb-2">Connectors</h3>
                <p className="text-gray-400 text-sm">Integrations with popular services like Slack, Discord, GitHub, and more.</p>
              </div>
              <div className="bg-black/30 p-4 rounded-lg">
                <h3 className="font-semibold text-white mb-2">Templates</h3>
                <p className="text-gray-400 text-sm">Starter templates for common agent patterns and architectures.</p>
              </div>
              <div className="bg-black/30 p-4 rounded-lg">
                <h3 className="font-semibold text-white mb-2">Tools</h3>
                <p className="text-gray-400 text-sm">Reusable tools and utilities that agents can use.</p>
              </div>
            </div>
          </section>
