    ...
    <div className="space-y-12">
      <header>
        ...
        <p className="text-xl text-gray-400">
          ReadyLayer uses a specialized multi-agent system where roles are strictly defined by
          capabilities and governance boundaries.
        </p>
      </header>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="card bg-white/5 p-6 rounded-xl border border-white/10">
            ...
            <p className="text-sm text-gray-400">
              Responsible for system design, maintaining invariants, and ensuring modular cohesion
              across the repository. Owns the <code>ADR</code> (Architectural Decision Record)
              lifecycle.
            </p>
          </div>
          <div className="card bg-white/5 p-6 rounded-xl border border-white/10">
            ...
            <p className="text-sm text-gray-400">
              Enforces linting, typechecking, and build stability. Executes hydration and
              performance passes and ensures vulnerability hygiene.
            </p>
          </div>
          <div className="card bg-white/5 p-6 rounded-xl border border-white/10">
            <h3 className="font-bold mb-2 text-accent">Design Agent</h3>
            <p className="text-sm text-gray-400">
              Ensures visual system integrity. Manages design tokens, UI coherence, and alignment
              with the canonical brand prompts.
            </p>
          </div>
          <div className="card bg-white/5 p-6 rounded-xl border border-white/10">
            <h3 className="font-bold mb-2 text-accent">Infrastructure Agent</h3>
            <p className="text-sm text-gray-400">
              Focuses on CI resilience, environment validation, security hardening, and production
        ...
        <div className="bg-black/40 border border-accent/20 rounded-xl p-8">
          <ul className="space-y-4 text-gray-400 font-medium">
            <li className="flex gap-4">
              ...
              <span>
                <strong>Production-grade:</strong> Agents must never emit placeholders, TODOs, or
                stubs.
              </span>
            </li>
            <li className="flex gap-4">
              <span className="text-accent shrink-0">●</span>
              <span>
                <strong>Deterministic Change:</strong> Prefer minimal diffs. Favor structural
                improvements over cosmetic ripples.
              </span>
            </li>
            <li className="flex gap-4">
              <span className="text-accent shrink-0">●</span>
              <span>
                <strong>Graceful Degradation:</strong> User-facing routes managed by agents must
                never hard-500.
              </span>
            </li>
            <li className="flex gap-4">
              <span className="text-accent shrink-0">●</span>
              <span>
                <strong>High Leverage:</strong> Optimize for clarity and minimal context usage in
      ...
      <section className="space-y-6">
        ...
        <p className="text-gray-400 text-sm">
          When new constraints or skills are introduced to an agent, they follow a three-step
          injection protocol:
        </p>
      ...
      <section className="space-y-6">
        ...
        <ul className="space-y-2 text-sm">
          <li>
            <code className="text-accent">/AGENTS.md</code> — Role definitions and responsibilities
          </li>
          <li>
            <code className="text-accent">/SKILLS.md</code> — Skill sets and capability mappings
          </li>
          <li>
            <code className="text-accent">/MODEL_SPEC.md</code> — Model constraints and routing
            rules
          </li>
        </ul>
      </section>
