...
export const metadata: Metadata = {
  ...
  description:
    "Authority reference for the ReadyLayer command line tool and diagnostic utility.",
};
    ...
    <div className="space-y-12">
      <header>
        ...
        <p className="text-xl text-gray-400">
          The <code>reach</code> CLI is the unified entry point for managing
          execution, diagnosing system health, and interacting with the
          ReadyLayer protocol.
        </p>
      </header>
      ...
      <section className="space-y-6">
        ...
        <div className="card bg-white/5 border border-white/10 p-8 rounded-xl">
          ...
          <p className="text-gray-400 mb-6">
            The single authoritative health command for trust and hardening
            checks. It validates the entire execution chain from registry to
            engine.
          </p>
        ...
        <div className="space-y-6">
          <div className="group">
            ...
            <p className="text-sm text-gray-400 mb-4">
              A guided, terminal-based UI for mobile and desktop. Walk through
              pack selection, risk acknowledgment, and execution with built-in
              safety checks.
            </p>
          ...
          <div className="group">
            ...
            <p className="text-sm text-gray-400 mb-4">
              Directly execute a signed pack. Requires the pack to exist in the
              local registry and all capability permissions to be
              pre-authorized.
            </p>
            <code className="bg-white/5 px-2 py-1 rounded text-accent text-xs">
          ...
          <div className="group">
            ...
            <p className="text-sm text-gray-400 mb-4">
              Dashboard mode. Displays a live view of the runner status, active
              executions, and system resource consumption.
            </p>
            <code className="bg-white/5 px-2 py-1 rounded text-accent text-xs">
              reach operator
            </code>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="card p-6 border border-white/5 rounded-xl">
            ...
            <p className="text-sm text-gray-400">
              Generates a tamper-evident execution capsule. On mobile, this
              produces a QR code for device-to-device verification.
            </p>
          </div>
          <div className="card p-6 border border-white/5 rounded-xl">
            <h3 className="font-bold mb-2">reach proof verify &lt;id&gt;</h3>
            <p className="text-sm text-gray-400">
              Performs a bit-perfect determinism check against the execution
              event log to verify that a run has not been tampered with.
            </p>
          </div>
        </div>
      </section>
