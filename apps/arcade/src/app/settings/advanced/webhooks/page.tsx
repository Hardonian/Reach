    ...
    <>
      ...
      <div className="card mb-6">
        ...
        <div className="space-y-3">
          {[
            {
              url: "https://hooks.acme.corp/reach/runs",
              events: "run.completed, run.failed",
              status: "Active",
              lastDelivery: "2 mins ago",
            },
            {
              url: "https://slack.acme.corp/webhooks/alerts",
        ...
        <table className="w-full text-left text-sm">
          ...
          <tbody className="divide-y divide-border">
            {[
              {
                event: "run.completed",
                endpoint: "hooks.acme.corp",
                code: "200",
                time: "2 mins ago",
              },
              {
                event: "alert.triggered",
                endpoint: "slack.acme.corp",
                code: "200",
                time: "1 hour ago",
              },
              {
              ...
              <tr key={i} className="hover:bg-white/[0.02] transition-colors">
                ...
                <td className="px-6 py-3">
                  <span className="status-pill online text-xs">{d.code}</span>
                </td>
