  ...
  return (
    <>
      ...
      <p className="text-gray-400 max-w-2xl mb-8">
        Manage your personal account details, developer access tokens, and
        security preferences for the {BRAND_NAME} Orchestration Plane.
      </p>
        ...
        <div className="lg:col-span-2 card flex flex-col sm:flex-row gap-6 items-start sm:items-center">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <span className="status-pill pending text-xs">
        ...
        <div className="border-b border-border px-6 py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-400">
              Manage API keys for accessing the {BRAND_NAME} platform via CLI or
              SDK.
            </p>
          </div>
