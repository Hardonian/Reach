  ...
  return (
    <>
      ...
      <p className="text-gray-400 max-w-2xl mb-8">
        Manage your personal account details, developer access tokens, and security preferences for
        the {BRAND_NAME} Orchestration Plane.
      </p>
        ...
        <div className="lg:col-span-2 card flex flex-col sm:flex-row gap-6 items-start sm:items-center">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-gray-400 text-sm mt-1">
              Primary Org: <span className="text-white font-medium">Acme Corp</span>
            </p>
        ...
        <div className="border-b border-border px-6 py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-400">
              Manage API keys for accessing the {BRAND_NAME} platform via CLI or SDK.
            </p>
          </div>
            ...
            <tbody className="divide-y divide-border">
              {keys.map((k) => (
                <tr key={k.id} className="hover:bg-white/[0.02] transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={`inline-flex items-center rounded-md px-2 py-1 text-xs font-medium ring-1 ring-inset ${k.scopeColor}`}
                    >
                      {k.scope}
                    </span>
                  </td>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    San Francisco, US · <span className="text-emerald-400">Current Session</span>
                  </p>
                </div>
              </div>
            </div>
