          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${
              filterType === "all"
                ...
                : "text-gray-400 hover:text-white bg-surface border border-border"
            }`}
          >
            All ({tools.length})
          </button>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 text-xs text-gray-600">
                      <span>
                        ...
                        {tool.permissions.length !== 1 ? "s" : ""}
                      </span>
                      <span>·</span>
                      <span>
                        {tool.boundSkills.length} skill
                        {tool.boundSkills.length !== 1 ? "s" : ""}
                      </span>
                    </div>
                  </button>
                );
            ...
            {selectedTool ? (
              <div className="card sticky top-24">
                <div className="flex items-center gap-3 mb-4">
                  <div
                    ...
                    style={{
                      backgroundColor: `${TOOL_TYPE_META[selectedTool.type].color}20`,
                    }}
                  >
                  ...
                  <div>
                    ...
                    <span className="text-xs text-gray-500">
                      {TOOL_TYPE_META[selectedTool.type].label}
                    </span>
                  </div>
                </div>
              ...
              <div className="card text-center py-12">
                ...
                <p className="text-sm text-gray-500">
                  Click a tool to view permissions, scope, and bindings.
                </p>
              </div>
            )}
          </div>
