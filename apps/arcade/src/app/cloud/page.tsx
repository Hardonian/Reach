    ...
    <div className="p-8 max-w-6xl">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <StatCard
          ...
          sub={
            data.billing?.usage?.runs_limit === -1
              ? "unlimited"
      ...
      <div className="mt-8 flex gap-3 flex-wrap">
        <Link
          href="#"
          className="px-4 py-2 bg-accent text-black text-sm font-semibold rounded-lg hover:bg-accent/90"
          title="Coming Soon"
        >
          + New Workflow
        </Link>
        <Link
          href="/marketplace"
          className="px-4 py-2 border border-border text-white text-sm rounded-lg hover:border-accent"
        >
          Browse Marketplace
        </Link>
        <Link
