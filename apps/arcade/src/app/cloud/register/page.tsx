...
export default function CloudRegisterPage() {
  ...
  function githubSignUp() {
    track('signup_started', { method: 'github_oauth', source: 'register_page' });
  ...
  async function handleMagicLink(e: React.FormEvent) {
    ...
    setInfo('');
    try {
      await track('signup_started', { method: 'magic_link', source: 'register_page' });
      ...
      if (!res.ok) { setError(data.error ?? 'Could not send link'); return; }
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-md">
        ...
        <div className="card p-8">
          ...
          <p className="text-xs text-gray-600 text-center mb-4">Fastest — imports your identity automatically</p>
