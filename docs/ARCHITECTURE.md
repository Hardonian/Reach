# Reach Architecture Boundaries ## Non-negotiable boundaries
...
## Import constraints enforced in CI/doctor - Marketplace API cannot import runner internals.
...
## Core trust invariants - Signature and SHA verification are mandatory unless explicit dev flags are set.
...
## Fun Layer: Reach Arcade ### Boundary Rules
