...
Policy Gate runs before pack-backed execution and evaluates:
- org policy
...
## Minimum deny rules
- Invalid or unsigned pack signature unless legacy unsigned is explicitly allowed.
...
## Compatibility
- `REACH_ALLOW_LEGACY_UNSIGNED_PACKS=false` by default.
