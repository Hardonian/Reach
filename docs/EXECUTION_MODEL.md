...
s for tools. 3. Policy gates validate requested tools and permissions. 4. Pack integrity and replay guards are enforced. 5. Events are persisted for audit and replay.
