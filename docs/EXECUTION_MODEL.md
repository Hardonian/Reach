...
Reach executes work through immutable execution packs and deterministic runtime contracts.

## Lifecycle

1. A run is created with tenant-scoped capabilities.
...
- Stable event sequencing for replay.
