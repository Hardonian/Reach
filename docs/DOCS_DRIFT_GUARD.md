# Documentation Drift Guard The Documentation Drift Guard is an automated system designed to prevent entropy between the Reach codebase, its documentation, and repository truth sources.

## Overview The system consists of several auditors that cross-check different aspects of the repository:
