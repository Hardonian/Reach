...
program
  ...
  .description('Reach Economics & Metrics Engine');
...
Results:`);
      ...
      console.log(`
Scale Triggers:`);
      if (analysis.users_needed > 1000) console.log(`  [!] High break-even point. Consider raising prices or optimizing token usage.`);
