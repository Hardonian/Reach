# Reach Execution Protocol ## 1. Overview
...
## 3. Data Structures ### 3.1 Execution Envelope
...
## 5. Security & Isolation - **Marketplace Containment**: Templates run in a restricted Executor instance with limited tool access.
