# Protocol Versioning Policy ## Versioning rules
...
## Breaking changes - A breaking change requires a major version bump (`v1` -> `v2`).
...
## Deprecation process 1. Mark fields/events as deprecated in documentation and release notes.
...
## Contract fixtures `protocol/examples/*.json` are golden fixtures used by runner, mobile, and VS Code contract tests.
