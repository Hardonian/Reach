...
_reach() {
    ...
    # Main commands
    local commands="doctor audit eval release-check serve federation support arcade capsule proof graph packs init explain operator pack wizard run share delegate verify-proof cost metrics gate report help"
