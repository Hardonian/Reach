...
This example demonstrates how the policy gate denies execution of packs with high-risk permissions.

## What This Pack Demonstrates

- **Policy enforcement**: The policy denies `sys:exec` permission
- **Governed execution**: Requires signing and verification
- **Denial recording**: Policy decisions are recorded in the event log

## The Policy

The `policy.rego` file:
