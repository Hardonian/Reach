 ...
 * 
 * Commands:
 * - reach junctions scan --since <time> --json
 * - reach junctions list
 * - reach junctions show <id>
 */

import { junctionOrchestrator } from './src/junctions/orchestrator';
import { Junction } from './apps/arcade/src/lib/db/junctions';
import { JUNCTION_TYPE_META, getSeverityLevel } from './src/junctions/types';
