# ReachArcadeDemo (minimal harness) This repository includes a compile-oriented harness directory intended for an Xcode app shell consuming `ReachSDK`.

## Setup 1. Open Xcode and create an iOS App project in this folder named `ReachArcadeDemo`.
