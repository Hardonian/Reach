# Reach Cloud Build - Baseline Report
**Date:** 2026-02-19
...
- **Runs:** Execution units with capabilities and tier-based limits
...
- `runs` - Run records with tenant isolation
...
### Architecture Notes
- Tenant isolation exists via `tenant_id` columns
